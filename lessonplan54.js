...
function generateSwahiliPhrases(verb, specificLesson, isContinue) {
    ...
    const reinAssessmentTemplates = [
        ...
        `Wanafunzi wamefanikiwa ${verbBase} ${specificLesson}`,
        `Utaalamu wa ${specificLesson} umedhihirishwa`,
        `Dhana za ${specificLesson} zimeimarishwa`,
        `Uelewa wa ${specificLesson} umethibitishwa`
    ];
    ...
    const reflectAssessmentTemplates = [
        ...
        `Uelewa wa kibinafsi wa ${specificLesson} umedhihirishwa`,
        `Kila mwanafunzi ameonyesha utaalamu wa ${specificLesson}`,
        `Uelewa wa mtu binafsi wa ${specificLesson} unaonekana`,
