(function() {
  const validDomain = "www.academixpoint.com";
  const currentDomain = window.location.hostname;

 
  if (currentDomain !== validDomain) {
    console.error("Invalid domain. Script not allowed to run on this domain.");
  ...
  const validUrls = [
    "/p/create-swahili-medium-lesson-plans.html",
    "/p/create-swahili-medium-lesson-plans.html?m=1",
    "/p/create-swahili-medium-lesson-plans.html#",
    "/p/create-swahili-medium-lesson-plans.html?m=1#"
  ];
  ...
  if (!validUrls.includes(currentUrl)) {
    console.error("This page is not allowed to run the script. URL mismatch.");
    document.body.innerHTML = "";
