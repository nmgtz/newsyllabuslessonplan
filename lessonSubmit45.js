...
function initDateTimeWidget() {
    ...
    function tick() {
        ...
        document.getElementById('ldtDay').textContent  = days[now.getDay()];
        document.getElementById('ldtDate').textContent = `${now.getDate()} ${months[now.getMonth()]} ${now.getFullYear()}`;
        document.getElementById('ldtTime').textContent = `${h12}:${m}:${s}`;
        document.getElementById('ldtAmpm').textContent = ampm;
    }
