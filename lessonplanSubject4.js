...
if ( window.location.href !== allowedHost) {
...
function createOptionElement() {
    ...
    if (subClasses === "Form One") {
        ...
        var referenceOptions = [
            ...
            { value: "Tanzania Institute of Education. (2022). Chemistry for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Physics for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Mathematics for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Chagua Rejea"},
            { value: "Taasisi ya Elimu Tanzania. (2022). Historia Ya Tanzania na Maadili kitabu cha mwanafunzi kwa shule za sekondari kidato cha kwanza. Taasisi ya Elimu Tanzania"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Biology for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). English Language for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Geography for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). History for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Business Studies for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Select Reference"},
            { value: "Tanzania Institute of Education. (2022). Book-Keeping for secondary schools student's book, form one. Tanzania Institute of Education"},
        ...
        var referenceOptions = [
            { value: "Chagua Rejea"},
            { value: "Taasisi ya Elimu Tanzania. (2022), kiswahili kitabu cha mwanafunzi kwa shule za sekondari kidato cha kwanza, Taasisi ya Elimu Tanzania."},
