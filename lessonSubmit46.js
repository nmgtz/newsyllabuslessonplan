...
function initDateTimeWidget() {
    ...
    document.getElementById('ldtHideBtn').addEventListener('click', function() {
        ...
        document.getElementById('ldtShowBtn').style.display = 'flex';
    ...
    // On resize to desktop, always restore full widget and remove padding
...
function addDateTimeWidgetStyles() {
    ...
    s.textContent = `
        ...
        /* ── Small clock icon shown when widget is hidden ── */
        .ldt-show-btn {
            width: 36px;
            height: 36px;
            background: #0d1b2a;
        ...
        /* Tablet */
        @media (max-width: 768px) {
            #lpDateTimeWidget { bottom: 10px; left: 10px; }
            .ldt-inner { padding: 7px 7px 7px 11px; min-width: 165px; }
            .ldt-time  { font-size: 1.05rem; }
            .ldt-date  { font-size: 0.72rem; }
            .ldt-day   { font-size: 0.63rem; }
            .ldt-hide-btn { display: flex; }
            .ldt-show-btn { width: 34px; height: 34px; font-size: 0.9rem; }
        }

        /* Mobile — full-width bar pinned to bottom */
        @media (max-width: 480px) {
            #lpDateTimeWidget { bottom: 0; left: 0; right: 0; }
            .ldt-full { width: 100%; }
            .ldt-inner {
            ...
            .ldt-time    { font-size: 1.05rem; }
            .ldt-divider { margin: 0 10px; }
            .ldt-show-btn { width: 40px; height: 40px; font-size: 1.05rem; }
        }

        /* Push page content up so the fixed widget never overlays anything */
        @media (max-width: 768px) {
