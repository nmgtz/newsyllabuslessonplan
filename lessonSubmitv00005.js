...
function buildAndDownloadPdf(filename, onSuccess) {
    ...
    const stageHPad = hPadFixed;
    const stageVPad = vPadFixed;
    ...
    doc.autoTable({
        ...
        styles: {
            ...base,
            fontSize:    8.5,
            cellPadding: { top: stageVPad, bottom: stageVPad, left: stageHPad, right: stageHPad },
            valign:      'middle',
            overflow:    'linebreak',
            lineWidth:   0.5,
        },
