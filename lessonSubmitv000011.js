...
lessonplanSubmit.addEventListener('click', function (mySb) {
    ...
    injectSuccessPanel();
    injectSuccessPanelStyles();          // ← add this
...
function buildAndDownloadPdf(filename, onSuccess) {
    ...
    doc.autoTable({
        ...
        pageBreak: 'avoid',
        rowPageBreak: 'avoid',
        styles:{ ...base, cellPadding:{ top:0.8, bottom:1, left:1, right:1 }, lineWidth:0 },
        columnStyles:{
    ...
    doc.autoTable({
        ...
        pageBreak: 'avoid',
        rowPageBreak: 'avoid',
        styles:{ ...base, cellPadding:{ top:1, bottom:1, left:1, right:1 }, halign:'center', valign:'middle', fontStyle:'bold' },
        head:[
    ...
    // Trimmed to the 14px→11px band (10.5pt → 8.25pt), with two safety-valve
    // sizes below for genuinely oversized cell content so text never clips.
    const fontScale = [10.5, 10.0, 9.5, 9.0, 8.5, 8.25, 7.0, 6.0];
