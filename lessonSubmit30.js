   ...
   class LessonPlanForm {
    ...
    const dateOption = document.getElementById("dateOption")?.value;  // ✅ Check option first
    ...
    // ✅ Date is only required if dateOption is "set"
    const isDateRequired = dateOption === 'set' ? !date : false;
    
    if (
        !hourCodes || !minCodes || !school || !teacherName || isDateRequired || !subject || !classes || 
