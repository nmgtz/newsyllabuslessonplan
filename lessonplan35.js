...
var lessonplanSubmit = document.getElementById("submit-lesson-plan");
    ...
    function updateContent() {
     ...
     if (subject === "Kiswahili" || subject === "Elimu Ya Dini Ya Kiislam" || subject === "Historia Ya Tanzania na Maadili"  ) {
         var schoolNm = document.getElementById("schoolNm");
        ...
        // somo.innerText = "somo";
         ...
         sylbsSbtp.innerText =`Ndani ya kipindi hiki mwanafunzi aweze `+ mainlesson; 
       ...
       if(period === "1 & 2" || period === "3 & 4" || period === "5 & 6" || period === "6 & 7" ||period === "8 & 9" ) {
        ...
        sylbsSpobj.innerText = `Ndani ya dakika 80,Mwanafunzi aweze ${wrdImp2} ${specificLesson}`;
        ...
        sylbsSpobj.innerText = `Ndani ya Ndani ya dakika 40,Mwanafunzi aweze ${wrdImp2} ${specificLesson}`;
