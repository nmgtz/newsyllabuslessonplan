...
function addDateTimeWidgetStyles() {
    ...
    s.textContent = `
        ...
        /* ── Below 768px: reposition to middle-left, compact ── */
        @media (max-width: 768px) {
            #lpDateTimeWidget {
                bottom: auto;
                top: 50%;
            ...
            .ldt-left  { gap: 1px; }
            .ldt-day   { font-size: 0.55rem; letter-spacing: 0.07em; }
            .ldt-date  { font-size: 0.6rem; }
            .ldt-divider {
                width: 100%; height: 1px;
                margin: 2px 0;
            }
            .ldt-right { align-items: baseline; gap: 3px; }
            .ldt-time  { font-size: 0.82rem; letter-spacing: 0; }
            .ldt-ampm  { font-size: 0.55rem; margin-bottom: 0; }
            .ldt-hide-btn {
                display: flex;
