  ...
  "sayansi"
     ...
     if (allowedSubjects.includes(subject.toLowerCase())) {
         ...
         var ShuleJina = document.getElementById("ShuleJina");
          document.getElementById("wrdImp2").innerHTML = `<option value="">Chagua neno la kutumia</option>
<option value="kuandika">kuandika</option>
                    <option value="kueleza">kueleza</option>
                    <option value="kujibu">kujibu</option>
                    <option value="kufupisha">kufupisha</option>
                    <option value="kubaini">kubaini</option>
                    <option value="kuhakiki">kuhakiki</option>
                    <option value="kuunda">kuunda</option>
                    <option value="kutunga">kutunga</option>
                    <option value="kupambanua">kupambanua</option>
                    <option value="kufafanua">kufafanua</option>
                    <option value="kuonesha">kuonesha</option>
                    <option value="kuainisha">kuainisha</option>
                    <option value="kusoma">kusoma</option>
                    <option value="kusimulia">kusimulia</option>`;
