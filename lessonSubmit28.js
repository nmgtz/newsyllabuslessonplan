                ...
                <div class="lesson-view-modal">
                    <div class="lesson-view-modal-header">
                        ...
                        <div class="lesson-view-actions">
                            <button class="lesson-view-btn download-btn" onclick="downloadLessonFromModal('${lessonName.replace(/'/g, "\\'")}')">
                                📥 Download
                            </button>
                    ...
                    <div class="lesson-view-footer">
                        ...
                        <div class="lesson-footer-actions">
                            ...
                            <button class="lesson-footer-btn primary-btn" onclick="downloadLessonFromModal('${lessonName.replace(/'/g, "\\'")}')">
                                📥 Download PDF
                            </button>
                        </div>
                    </div>
