...
function buildEnglishAssessment(conceptType, coreSubject, original, stage) {
    ...
    const byStage = {
        development: {
            meaning_importance:  [`Each student is able to define and list the importance of ${coreSubject}`, `Each student is able to state the meaning and at least two points of importance of ${coreSubject}`, `Each student is able to demonstrate understanding of the meaning and importance of ${coreSubject}`],
            meaning:             [`Each student is able to define ${coreSubject} in their own words`, `Each student is able to explain the meaning of ${coreSubject}`, `Each student is able to provide a definition of ${coreSubject}`],
            importance:          [`Each student is able to list and explain at least two points on the importance of ${coreSubject}`, `Each student is able to identify the importance of ${coreSubject}`, `Each student is able to state the importance of ${coreSubject}`],
            effects:             [`Each student is able to identify both positive and negative effects of ${coreSubject}`, `Each student is able to state the effects of ${coreSubject}`, `Each student is able to differentiate between positive and negative effects of ${coreSubject}`],
            causes:              [`Each student is able to list and rank the main causes of ${coreSubject}`, `Each student is able to identify the causes of ${coreSubject}`, `Each student is able to state the factors that cause ${coreSubject}`],
            advantages:          [`Each student is able to identify and explain the benefits of ${coreSubject}`, `Each student is able to list the advantages of ${coreSubject}`, `Each student is able to describe the advantages of ${coreSubject}`],
            disadvantages:       [`Each student is able to propose solutions to the drawbacks of ${coreSubject}`, `Each student is able to identify the disadvantages of ${coreSubject}`, `Each student is able to state the disadvantages of ${coreSubject}`],
            adv_disadv:          [`Each student is able to evaluate the benefits and drawbacks of ${coreSubject}`, `Each student is able to compare the advantages and disadvantages of ${coreSubject}`, `Each student is able to identify both advantages and disadvantages of ${coreSubject}`],
            types:               [`Each student is able to classify and give examples of each type of ${coreSubject}`, `Each student is able to identify and name the types of ${coreSubject}`, `Each student is able to describe the types of ${coreSubject}`],
            characteristics:     [`Each student is able to identify the features of ${coreSubject}`, `Each student is able to list the characteristics of ${coreSubject}`, `Each student is able to describe the characteristics of ${coreSubject}`],
            steps:               [`Each student is able to describe each step involved in ${coreSubject}`, `Each student is able to sequence the steps of ${coreSubject}`, `Each student is able to identify the main steps of ${coreSubject}`],
            examples:            [`Each student is able to provide appropriate examples of ${coreSubject} from real life`, `Each student is able to identify relevant examples of ${coreSubject}`, `Each student is able to give examples of ${coreSubject}`],
            definition:          [`Each student is able to write a definition of ${coreSubject}`, `Each student is able to define ${coreSubject} in their own words`, `Each student is able to provide a clear definition of ${coreSubject}`],
            uses:                [`Each student is able to list and explain the uses of ${coreSubject}`, `Each student is able to identify the uses of ${coreSubject}`, `Each student is able to state at least two uses of ${coreSubject}`],
            functions:           [`Each student is able to explain what each function of ${coreSubject} does`, `Each student is able to list the functions of ${coreSubject}`, `Each student is able to state the functions of ${coreSubject}`],
            components:          [`Each student is able to identify the role of each component of ${coreSubject}`, `Each student is able to name the components of ${coreSubject}`, `Each student is able to identify the components of ${coreSubject}`],
            solutions:           [`Each student is able to evaluate and select the most practical solution to ${coreSubject}`, `Each student is able to propose a solution to ${coreSubject}`, `Each student is able to identify solutions to ${coreSubject}`],
            generic:             [`Each student is able to explain key concepts of ${original}`, `Each student is able to demonstrate understanding of ${original}`, `Each student is able to respond to questions about ${original}`],
        },
        design: {
            meaning_importance:  [`Each student is able to state the meaning and importance of ${coreSubject}`, `Each student is able to explain the meaning and importance of ${coreSubject}`, `Each student is able to identify the meaning and importance of ${coreSubject}`],
            meaning:             [`Each student is able to explain the meaning of ${coreSubject}`, `Each student is able to define ${coreSubject}`, `Each student is able to state the meaning of ${coreSubject}`],
            importance:          [`Each student is able to state the importance of ${coreSubject}`, `Each student is able to identify the importance of ${coreSubject}`, `Each student is able to explain why ${coreSubject} is important`],
            effects:             [`Each student is able to identify and explain the effects of ${coreSubject}`, `Each student is able to state the effects of ${coreSubject}`, `Each student is able to differentiate the effects of ${coreSubject}`],
            causes:              [`Each student is able to identify the causes of ${coreSubject}`, `Each student is able to list the causes of ${coreSubject}`, `Each student is able to explain what causes ${coreSubject}`],
            advantages:          [`Each student is able to list the advantages of ${coreSubject}`, `Each student is able to identify the benefits of ${coreSubject}`, `Each student is able to explain the advantages of ${coreSubject}`],
            disadvantages:       [`Each student is able to identify the disadvantages of ${coreSubject}`, `Each student is able to state the drawbacks of ${coreSubject}`, `Each student is able to describe the disadvantages of ${coreSubject}`],
            adv_disadv:          [`Each student is able to compare the advantages and disadvantages of ${coreSubject}`, `Each student is able to evaluate both sides of ${coreSubject}`, `Each student is able to list the advantages and disadvantages of ${coreSubject}`],
            types:               [`Each student is able to identify and describe the types of ${coreSubject}`, `Each student is able to name and classify the types of ${coreSubject}`, `Each student is able to differentiate the types of ${coreSubject}`],
            characteristics:     [`Each student is able to list and explain the characteristics of ${coreSubject}`, `Each student is able to identify the characteristics of ${coreSubject}`, `Each student is able to describe the features of ${coreSubject}`],
            steps:               [`Each student is able to arrange the steps of ${coreSubject} in order`, `Each student is able to sequence the steps involved in ${coreSubject}`, `Each student is able to identify the steps of ${coreSubject}`],
            examples:            [`Each student is able to identify relevant examples of ${coreSubject}`, `Each student is able to give examples of ${coreSubject}`, `Each student is able to provide real-life examples of ${coreSubject}`],
            definition:          [`Each student is able to define ${coreSubject} in their own words`, `Each student is able to write a definition of ${coreSubject}`, `Each student is able to state the definition of ${coreSubject}`],
            uses:                [`Each student is able to identify the uses of ${coreSubject}`, `Each student is able to list the uses of ${coreSubject}`, `Each student is able to state uses of ${coreSubject}`],
            functions:           [`Each student is able to list and describe the functions of ${coreSubject}`, `Each student is able to identify the functions of ${coreSubject}`, `Each student is able to explain the functions of ${coreSubject}`],
            components:          [`Each student is able to name and describe the components of ${coreSubject}`, `Each student is able to identify the components of ${coreSubject}`, `Each student is able to state the components of ${coreSubject}`],
            solutions:           [`Each student is able to propose solutions to ${coreSubject}`, `Each student is able to identify solutions to ${coreSubject}`, `Each student is able to suggest ways to address ${coreSubject}`],
            generic:             [`Each student is able to demonstrate understanding of ${original}`, `Each student is able to respond to tasks about ${original}`, `Each student is able to complete the assigned tasks on ${original}`],
        },
        realization: {
            meaning_importance:  [`Each student is able to state the meaning and importance of ${coreSubject} individually`, `Each student is able to independently explain the meaning and importance of ${coreSubject}`, `Each student is able to identify the meaning and importance of ${coreSubject} on their own`],
            meaning:             [`Each student is able to independently define ${coreSubject}`, `Each student is able to state the meaning of ${coreSubject} on their own`, `Each student is able to define ${coreSubject} independently`],
            importance:          [`Each student is able to independently state the importance of ${coreSubject}`, `Each student is able to identify the importance of ${coreSubject} on their own`, `Each student is able to explain the importance of ${coreSubject} independently`],
            effects:             [`Each student is able to independently state the effects of ${coreSubject}`, `Each student is able to identify the effects of ${coreSubject} on their own`, `Each student is able to describe the effects of ${coreSubject} individually`],
            causes:              [`Each student is able to independently state the causes of ${coreSubject}`, `Each student is able to identify the causes of ${coreSubject} on their own`, `Each student is able to state causes of ${coreSubject} individually`],
            advantages:          [`Each student is able to independently state the advantages of ${coreSubject}`, `Each student is able to identify the advantages of ${coreSubject} on their own`, `Each student is able to list advantages of ${coreSubject} individually`],
            disadvantages:       [`Each student is able to independently state the disadvantages of ${coreSubject}`, `Each student is able to identify the disadvantages of ${coreSubject} on their own`, `Each student is able to describe disadvantages of ${coreSubject} individually`],
            adv_disadv:          [`Each student is able to independently compare the advantages and disadvantages of ${coreSubject}`, `Each student is able to identify both advantages and disadvantages of ${coreSubject} on their own`, `Each student is able to state the advantages and disadvantages of ${coreSubject} individually`],
            types:               [`Each student is able to independently identify and name the types of ${coreSubject}`, `Each student is able to name the types of ${coreSubject} on their own`, `Each student is able to classify ${coreSubject} into its types individually`],
            characteristics:     [`Each student is able to independently list the characteristics of ${coreSubject}`, `Each student is able to state the characteristics of ${coreSubject} on their own`, `Each student is able to identify the characteristics of ${coreSubject} individually`],
            steps:               [`Each student is able to independently list the steps of ${coreSubject}`, `Each student is able to sequence the steps of ${coreSubject} on their own`, `Each student is able to state the steps of ${coreSubject} individually`],
            examples:            [`Each student is able to independently give an example of ${coreSubject}`, `Each student is able to provide an example of ${coreSubject} on their own`, `Each student is able to give a real-life example of ${coreSubject} individually`],
            definition:          [`Each student is able to independently define ${coreSubject}`, `Each student is able to state a definition of ${coreSubject} on their own`, `Each student is able to define ${coreSubject} individually`],
            uses:                [`Each student is able to independently state the uses of ${coreSubject}`, `Each student is able to identify uses of ${coreSubject} on their own`, `Each student is able to list uses of ${coreSubject} individually`],
            functions:           [`Each student is able to independently state a function of ${coreSubject}`, `Each student is able to identify a function of ${coreSubject} on their own`, `Each student is able to explain a function of ${coreSubject} individually`],
            components:          [`Each student is able to independently identify a component of ${coreSubject}`, `Each student is able to name a component of ${coreSubject} on their own`, `Each student is able to identify components of ${coreSubject} individually`],
            solutions:           [`Each student is able to independently propose a solution to ${coreSubject}`, `Each student is able to suggest a solution to ${coreSubject} on their own`, `Each student is able to propose ways to address ${coreSubject} individually`],
            generic:             [`Each student is able to independently demonstrate understanding of ${original}`, `Each student is able to respond to individual tasks about ${original}`, `Each student is able to show understanding of ${original} on their own`],
        }
    };
...
function buildSwahiliAssessment(conceptType, coreSubject, original, stage) {
    const byStage = {
        development: {
            meaning_importance:  [`Kila mwanafunzi anaweza kubainisha maana na umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kusema maana na mambo mawili ya umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kuonyesha uelewa wa maana na umuhimu wa ${coreSubject}`],
            meaning:             [`Kila mwanafunzi anaweza kufafanua maana ya ${coreSubject} kwa maneno yake`, `Kila mwanafunzi anaweza kufafanua ${coreSubject}`, `Kila mwanafunzi anaweza kutoa ufafanuzi wa ${coreSubject}`],
            importance:          [`Kila mwanafunzi anaweza kuorodhesha na kueleza mambo mawili ya umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kutaja umuhimu wa ${coreSubject}`],
            effects:             [`Kila mwanafunzi anaweza kubainisha athara nzuri na mbaya za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja athara za ${coreSubject}`, `Kila mwanafunzi anaweza kutofautisha athara nzuri na mbaya za ${coreSubject}`],
            causes:              [`Kila mwanafunzi anaweza kuorodhesha na kupanga sababu kuu za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha sababu za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja mambo yanayosababisha ${coreSubject}`],
            advantages:          [`Kila mwanafunzi anaweza kutambua na kueleza faida za ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha faida za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza faida za ${coreSubject}`],
            disadvantages:       [`Kila mwanafunzi anaweza kupendekeza suluhu za changamoto za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja hasara za ${coreSubject}`],
            adv_disadv:          [`Kila mwanafunzi anaweza kutathmini faida na hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kulinganisha faida na hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha faida na hasara za ${coreSubject}`],
            types:               [`Kila mwanafunzi anaweza kuainisha na kutoa mifano ya kila aina ya ${coreSubject}`, `Kila mwanafunzi anaweza kutambua aina za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza aina za ${coreSubject}`],
            characteristics:     [`Kila mwanafunzi anaweza kutambua sifa za ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha sifa za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza sifa za ${coreSubject}`],
            steps:               [`Kila mwanafunzi anaweza kueleza kila hatua ya ${coreSubject}`, `Kila mwanafunzi anaweza kupanga hatua za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha hatua kuu za ${coreSubject}`],
            examples:            [`Kila mwanafunzi anaweza kutoa mifano inayofaa ya ${coreSubject} kutoka maishani`, `Kila mwanafunzi anaweza kutambua mifano ya ${coreSubject}`, `Kila mwanafunzi anaweza kutoa mifano ya ${coreSubject}`],
            definition:          [`Kila mwanafunzi anaweza kuandika ufafanuzi wa ${coreSubject}`, `Kila mwanafunzi anaweza kufafanua ${coreSubject} kwa maneno yake`, `Kila mwanafunzi anaweza kutoa ufafanuzi wazi wa ${coreSubject}`],
            uses:                [`Kila mwanafunzi anaweza kuorodhesha na kueleza matumizi ya ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha matumizi ya ${coreSubject}`, `Kila mwanafunzi anaweza kutaja matumizi mawili ya ${coreSubject}`],
            functions:           [`Kila mwanafunzi anaweza kueleza kazi ya kila sehemu ya ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha kazi za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja kazi za ${coreSubject}`],
            components:          [`Kila mwanafunzi anaweza kutambua jukumu la kila sehemu ya ${coreSubject}`, `Kila mwanafunzi anaweza kutaja sehemu za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha sehemu za ${coreSubject}`],
            solutions:           [`Kila mwanafunzi anaweza kulinganisha na kuchagua suluhu bora ya ${coreSubject}`, `Kila mwanafunzi anaweza kupendekeza suluhu ya ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha suluhu za ${coreSubject}`],
            generic:             [`Kila mwanafunzi anaweza kueleza dhana kuu za ${original}`, `Kila mwanafunzi anaweza kuonyesha uelewa wa ${original}`, `Kila mwanafunzi anaweza kujibu maswali kuhusu ${original}`],
        },
        design: {
            meaning_importance:  [`Kila mwanafunzi anaweza kutaja maana na umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kueleza maana na umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha wazi maana na umuhimu wa ${coreSubject}`],
            meaning:             [`Kila mwanafunzi anaweza kueleza maana ya ${coreSubject}`, `Kila mwanafunzi anaweza kufafanua ${coreSubject}`, `Kila mwanafunzi anaweza kusema maana ya ${coreSubject}`],
            importance:          [`Kila mwanafunzi anaweza kutaja umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha umuhimu wa ${coreSubject}`, `Kila mwanafunzi anaweza kueleza kwa nini ${coreSubject} ni muhimu`],
            effects:             [`Kila mwanafunzi anaweza kubainisha na kueleza athara za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja athara za ${coreSubject}`, `Kila mwanafunzi anaweza kutofautisha athara za ${coreSubject}`],
            causes:              [`Kila mwanafunzi anaweza kubainisha sababu za ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha sababu za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza kinachosababisha ${coreSubject}`],
            advantages:          [`Kila mwanafunzi anaweza kuorodhesha faida za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha faida za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza faida za ${coreSubject}`],
            disadvantages:       [`Kila mwanafunzi anaweza kubainisha hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza hasara za ${coreSubject}`],
            adv_disadv:          [`Kila mwanafunzi anaweza kulinganisha faida na hasara za ${coreSubject}`, `Kila mwanafunzi anaweza kutathmini pande mbili za ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha faida na hasara za ${coreSubject}`],
            types:               [`Kila mwanafunzi anaweza kubainisha na kueleza aina za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja na kuainisha aina za ${coreSubject}`, `Kila mwanafunzi anaweza kutofautisha aina za ${coreSubject}`],
            characteristics:     [`Kila mwanafunzi anaweza kuorodhesha na kueleza sifa za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha sifa za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza vipengele vya ${coreSubject}`],
            steps:               [`Kila mwanafunzi anaweza kupanga hatua za ${coreSubject} kwa mpangilio`, `Kila mwanafunzi anaweza kupanga hatua zinazohusika na ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha hatua za ${coreSubject}`],
            examples:            [`Kila mwanafunzi anaweza kutambua mifano ya ${coreSubject}`, `Kila mwanafunzi anaweza kutoa mifano ya ${coreSubject}`, `Kila mwanafunzi anaweza kutoa mifano ya kweli ya ${coreSubject}`],
            definition:          [`Kila mwanafunzi anaweza kufafanua ${coreSubject} kwa maneno yake`, `Kila mwanafunzi anaweza kuandika ufafanuzi wa ${coreSubject}`, `Kila mwanafunzi anaweza kutaja ufafanuzi wa ${coreSubject}`],
            uses:                [`Kila mwanafunzi anaweza kubainisha matumizi ya ${coreSubject}`, `Kila mwanafunzi anaweza kuorodhesha matumizi ya ${coreSubject}`, `Kila mwanafunzi anaweza kutaja matumizi ya ${coreSubject}`],
            functions:           [`Kila mwanafunzi anaweza kuorodhesha na kueleza kazi za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha kazi za ${coreSubject}`, `Kila mwanafunzi anaweza kueleza kazi za ${coreSubject}`],
            components:          [`Kila mwanafunzi anaweza kutaja na kueleza sehemu za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha sehemu za ${coreSubject}`, `Kila mwanafunzi anaweza kutaja sehemu za ${coreSubject}`],
            solutions:           [`Kila mwanafunzi anaweza kupendekeza suluhu za ${coreSubject}`, `Kila mwanafunzi anaweza kubainisha suluhu za ${coreSubject}`, `Kila mwanafunzi anaweza kupendekeza njia za kushughulikia ${coreSubject}`],
            generic:             [`Kila mwanafunzi anaweza kuonyesha uelewa wa ${original}`, `Kila mwanafunzi anaweza kujibu kazi za ${original}`, `Kila mwanafunzi anaweza kukamilisha kazi zilizopewa kuhusu ${original}`],
        },
        realization: {
            meaning_importance:  [`Kila mwanafunzi anaweza kusema maana na umuhimu wa ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kufafanua maana na umuhimu wa ${coreSubject} bila msaada`, `Kila mwanafunzi anaweza kubainisha maana na umuhimu wa ${coreSubject} kwa kujitegemea`],
            meaning:             [`Kila mwanafunzi anaweza kufafanua ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kusema maana ya ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kufafanua ${coreSubject} bila msaada`],
            importance:          [`Kila mwanafunzi anaweza kutaja umuhimu wa ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha umuhimu wa ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kueleza umuhimu wa ${coreSubject} bila msaada`],
            effects:             [`Kila mwanafunzi anaweza kutaja athara za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha athara za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kueleza athara za ${coreSubject} bila msaada`],
            causes:              [`Kila mwanafunzi anaweza kutaja sababu za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha sababu za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kutaja sababu za ${coreSubject} bila msaada`],
            advantages:          [`Kila mwanafunzi anaweza kutaja faida za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kuorodhesha faida za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kubainisha faida za ${coreSubject} bila msaada`],
            disadvantages:       [`Kila mwanafunzi anaweza kutaja hasara za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha hasara za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kueleza hasara za ${coreSubject} bila msaada`],
            adv_disadv:          [`Kila mwanafunzi anaweza kulinganisha faida na hasara za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha faida na hasara za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kutaja faida na hasara za ${coreSubject} bila msaada`],
            types:               [`Kila mwanafunzi anaweza kutambua na kutaja aina za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutaja aina za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kuainisha ${coreSubject} katika aina zake bila msaada`],
            characteristics:     [`Kila mwanafunzi anaweza kuorodhesha sifa za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutaja sifa za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kubainisha sifa za ${coreSubject} bila msaada`],
            steps:               [`Kila mwanafunzi anaweza kuorodhesha hatua za ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kupanga hatua za ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kutaja hatua za ${coreSubject} bila msaada`],
            examples:            [`Kila mwanafunzi anaweza kutoa mfano wa ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutoa mfano wa ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kutoa mfano wa kweli wa ${coreSubject} bila msaada`],
            definition:          [`Kila mwanafunzi anaweza kufafanua ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutaja ufafanuzi wa ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kufafanua ${coreSubject} bila msaada`],
            uses:                [`Kila mwanafunzi anaweza kutaja matumizi ya ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha matumizi ya ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kuorodhesha matumizi ya ${coreSubject} bila msaada`],
            functions:           [`Kila mwanafunzi anaweza kutaja kazi ya ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kubainisha kazi ya ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kueleza kazi ya ${coreSubject} bila msaada`],
            components:          [`Kila mwanafunzi anaweza kutambua sehemu ya ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutaja sehemu ya ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kubainisha sehemu za ${coreSubject} bila msaada`],
            solutions:           [`Kila mwanafunzi anaweza kupendekeza suluhu ya ${coreSubject} peke yake`, `Kila mwanafunzi anaweza kutoa suluhu ya ${coreSubject} kwa kujitegemea`, `Kila mwanafunzi anaweza kupendekeza njia za kushughulikia ${coreSubject} bila msaada`],
            generic:             [`Kila mwanafunzi anaweza kuonyesha uelewa wa ${original} peke yake`, `Kila mwanafunzi anaweza kujibu kazi za mtu binafsi za ${original}`, `Kila mwanafunzi anaweza kuonyesha uelewa wa ${original} kwa kujitegemea`],
        }
    };
